...
namespace NativeWebSocket
{
  ...
  public class WebSocket : IWebSocket {
    ...
    public static extern int UOSWebSocketConnect (int instanceId);

    [DllImport ("__Internal")]
    public static extern int UOSWebSocketClose (int instanceId, int code, string reason);

    [DllImport ("__Internal")]
    public static extern int UOSWebSocketSend (int instanceId, byte[] dataPtr, int dataLength);

    [DllImport ("__Internal")]
    public static extern int UOSWebSocketSendText (int instanceId, string message);

    [DllImport ("__Internal")]
    public static extern int UOSWebSocketGetState (int instanceId);
    ...
    public WebSocket (string url, Dictionary<string, string> headers = null) {
      ...
      int instanceId = WebSocketFactory.UOSWebSocketAllocate (url);
    ...
    public WebSocket (string url, string subprotocol, Dictionary<string, string> headers = null) {
      ...
      WebSocketFactory.UOSWebSocketAddSubProtocol(instanceId, subprotocol);
    ...
    public Task Connect () {
      int ret = UOSWebSocketConnect (this.instanceId);
    ...
    public Task Close (WebSocketCloseCode code = WebSocketCloseCode.Normal, string reason = null) {
      int ret = UOSWebSocketClose (this.instanceId, (int) code, reason);
    ...
    public Task Send (byte[] data) {
      int ret = UOSWebSocketSend (this.instanceId, data, data.Length);
    ...
    public Task SendText (string message) {
      int ret = UOSWebSocketSendText (this.instanceId, message);
    ...
    public WebSocketState State {
      get {
        int state = UOSWebSocketGetState (this.instanceId);
    ...
    [DllImport ("__Internal")]
    public static extern int UOSWebSocketAllocate (string url);

    [DllImport ("__Internal")]
    public static extern int UOSWebSocketAddSubProtocol (int instanceId, string subprotocol);

    [DllImport ("__Internal")]
    public static extern void UOSWebSocketFree (int instanceId);

    [DllImport ("__Internal")]
    public static extern void UOSWebSocketSetOnOpen (OnOpenCallback callback);

    [DllImport ("__Internal")]
    public static extern void UOSWebSocketSetOnMessage (OnMessageCallback callback);

    [DllImport ("__Internal")]
    public static extern void UOSWebSocketSetOnError (OnErrorCallback callback);

    [DllImport ("__Internal")]
    public static extern void UOSWebSocketSetOnClose (OnCloseCallback callback);
    ...
    public static void Initialize () {
      ...
      UOSWebSocketSetOnOpen (DelegateOnOpenEvent);
      UOSWebSocketSetOnMessage (DelegateOnMessageEvent);
      UOSWebSocketSetOnError (DelegateOnErrorEvent);
      UOSWebSocketSetOnClose (DelegateOnCloseEvent);

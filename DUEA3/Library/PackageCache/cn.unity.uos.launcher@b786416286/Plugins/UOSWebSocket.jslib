...
var LibraryWebSocket = {
	 ...
	 */
	UOSWebSocketSetOnOpen: function(callback) {
	 ...
	 * @param callback Reference to C# static function
	 */
	UOSWebSocketSetOnMessage: function(callback) {
	 ...
	 * @param callback Reference to C# static function
	 */
	UOSWebSocketSetOnError: function(callback) {
	 ...
	 * @param callback Reference to C# static function
	 */
	UOSWebSocketSetOnClose: function(callback) {
	 ...
	 */
	UOSWebSocketAllocate: function(url) {
   ...
   */
  UOSWebSocketAddSubProtocol: function(instanceId, subprotocol) {
	 ...
	 * @param instanceId Instance ID
	 */
	UOSWebSocketFree: function(instanceId) {
	 ...
	 * @param instanceId Instance ID
	 */
	UOSWebSocketConnect: function(instanceId) {
	 ...
	 */
	UOSWebSocketClose: function(instanceId, code, reasonPtr) {
	 ...
	 */
	UOSWebSocketSend: function(instanceId, bufferPtr, length) {
	 ...
	 * @param length Length of the message in the buffer
	 */
	UOSWebSocketSendText: function(instanceId, message) {
	 ...
	 * @param instanceId Instance ID
	 */
	UOSWebSocketGetState: function(instanceId) {
